...
@task
def powerfit(options: dict, template: str) -> tuple[str, str]:
...
@task
def fit_model_task(row : dict[str, Any]):
...
@dag("protein_detective_minimal_workflow", params={
...
def minimal_workflow(
    ...
    filtered_af_files = filter_af_task(af_entries, density_query)
